    ...
    <div class="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
        ...
        <div class="p-6">
            @if($myTournaments->count() > 0)
                ...
                @if($totalTournamentsCount > 5)
                    <div class="mt-6 text-center">
                        <a href="{{ route('dashboard.tournaments.index') }}" class="text-pink-400 hover:text-pink-300 text-sm font-medium">
                            View all {{ $totalTournamentsCount }} tournaments →
                        </a>
                    </div>
                @endif
            @else
